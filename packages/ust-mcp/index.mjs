...
export const tools = [
  ...
  },
  {
    ...
    inputSchema: { type: 'object', required: ['doc', 'genesis', 'keylog'], properties: { doc: { type: 'object' }, genesis: { type: 'object' }, keylog: { type: 'array' }, noForkConfirmed: { type: 'boolean' }, anchorTime: { type: 'string' }, keylogFreshAsOf: { type: 'string', description: '#40 RFC3339-Z of an authoritative key-log fetch → identity.freshness' }, anchoredKeylogHead: { type: 'string', description: '#40 content_hash of the anchored key-log head → freshness:attested' } } },
    handler: ({ doc, genesis, keylog, noForkConfirmed, anchorTime, keylogFreshAsOf, anchoredKeylogHead }) => P.resolveAuthority(doc, { genesis, keylog, noForkConfirmed, anchorTime, keylogFreshAsOf, anchoredKeylogHead }),
  },
  {
