# UST 1.0.0-rc.1 — External Audit Brief
...
- **Two independent implementations** (`ust-protocol` node + `ust-verify-web` clean-room WebCrypto) cross-checked
  on the LIGHT floor: **17/17 agree, 0 divergence**.
